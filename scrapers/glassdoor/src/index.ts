...
async function scrape(_req: ScrapeRequest): Promise<ScrapeResponse> {
  // TODO: implement Glassdoor scraping via Playwright
  return { jobs: [], error: "Glassdoor scraper not yet implemented" };
}
...
server.listen(PORT, () => {
  console.log(`Glassdoor scraper listening on port ${PORT}`);
});
